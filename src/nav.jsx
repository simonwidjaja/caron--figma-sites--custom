    ...
    items: [
      ...
      },
      {
        ...
        items: [
          {
            name: 'Produktwelten',
            description: 'Interaktive und begehbare Produktwelten',
            href: '/produktwelten',
            icon: CubeIcon,
          },
          {
            name: 'Interaktive Infografiken',
            description: 'Fesselndes Storytelling durch Rich Content',
            href: '#',
            icon: CursorArrowRippleIcon,
          },
          {
            name: 'Marketing Experiences',
            description: 'Maßgeschneiderte interaktive Erlebnisse',
            href: '#',
            icon: FunnelIcon,
          },
          {
            name: 'Video und Animation',
            description: 'Visuelles Storytelling (Video, 3D, Animation)',
            href: '#',
            icon: FilmIcon,
          },
          {
            name: 'Conversion Boosters',
            description: 'Interaktive Tools zur Conversion-Steigerung',
            href: '#',
