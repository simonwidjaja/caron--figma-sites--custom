                  ...
                  {({ open, close }) => {
                    ...
                    return (
                      <>
                        ...
                        <PopoverPanel
                          transition
                          className="absolute inset-x-0 top-16 bg-white rounded-3xl transition data-closed:-translate-y-1 data-closed:opacity-0 data-enter:duration-200 data-enter:ease-out data-leave:duration-150 data-leave:ease-in mt-7 z-20 shadow-lg ring-1 ring-gray-900/5"
                        >
                            ...
                            <div className="mx-auto grid grid-cols-4 gap-x-4 px-12 py-10 xl:gap-x-8">
                              ...
                              <div>
                                <div className="relative">
                                  <Link href={getLocalizedUrlFromHref('/discover', lang)}>
